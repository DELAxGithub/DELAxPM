    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="text-center">
              <div className="icon-container bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-600 transition-colors">
                <svg className="w-8 h-8 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" width="32" height="32">
          ...
          >
            <div className="text-center">
              <div className="icon-container bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-green-600 transition-colors">
                <svg className="w-8 h-8 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" width="32" height="32">
            ...
            <div className="flex justify-center space-x-4">
              ...
              {isGuest ? (
                ...
                <>
                  ...
                  <WeeklyReviewButton />
                  {(user?.email === 'admin@example.com' || process.env.NEXT_PUBLIC_DEBUG_MODE === 'true') && (
                    <Link
                      href="/admin"
