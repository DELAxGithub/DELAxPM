-- ==============================================================================
-- PMliberary既存データを保護した正確なPMplattoデータ挿入スクリプト
-- バックアップソース: pmplatto_programs_2025-07-23T14-58-39.json (32番組)
-- ==============================================================================
-- 
...
SELECT 'DELA×PM統合システム - 正確なPMplattoデータ移行が完了しました！' as final_status;